...
ALL_CFLAGS = $(C_OPTS) $(DEFINES) $(CFLAGS) $(GAME_OPTS)
...
$(NAME)_emu: $(GAME_C_FILES) ../lib/emulator.c 
	gcc -O1 $(GAME_C_FILES)  -DEMULATED -I ../lib/ -I. ../lib/emulator.c  -g -Wall -std=c99 \
	-lm `sdl-config --cflags --libs` $(GAME_OPTS) -o $(NAME)_emu
